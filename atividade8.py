def opções():
    option_1 = "1. Conte o número total de palavras digitadas."
    option_2 = "2. Conte o número de vogais na palavra digitada."
    option_3 = "3. Substitua a palavra Python por Java."
    option_4 = "4. Converta todas as letras para minúsculas."
    option_5 = "5. Crie uma lista com todas as palavras únicas encontradas no texto (ignorando maiúsculas/minúsculas)."
    option_6 = "6. Imprima as palavras em ordem alfabética."
    ...
    print(option_5)
    print(option_6)
    option_selector = input("Digite a opção que deseja: ")
